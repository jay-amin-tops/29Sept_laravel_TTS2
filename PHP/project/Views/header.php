<!--
    ...
    <html lang="en">
      <head>
        ...
        <link rel="stylesheet" href="<?php echo $this->BaseURLDynamic;?>css/style-starter.css">
        <script src="<?php echo $this->BaseURLDynamic;?>lib/jquery.js"></script>
        <!-- <script src="<?php echo $this->BaseURLDynamic;?>dist/jquery.validate.js"></script> -->
    ...
    <section class="w3l-top-menu-1">
        ...
        <header class="row top-menu-top">
            ...
            <div class="social-top col-md-3 col-6">
                <a href="login" class="btn btn-secondary btn-theme4">Signin</a>
            </div>
        </header>
    </div>
    </div>
    ...
    <section class="w3l-bootstrap-header">
      <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
        <div class="container">
          <a class="navbar-brand" href="home"><span class="fa fa-pencil-square-o "></span> Mastery</a>
